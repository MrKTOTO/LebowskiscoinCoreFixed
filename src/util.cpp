...
const char * const BITCOIN_PID_FILENAME = "lebowskiscoind.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "LebowskisCoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/LebowskisCoin";
#else
    // Unix
    return pathRet / ".lebowskiscoin";
#endif
#endif
}
