# Contributing to LebowskisCoin Core

LebowskisCoin Core is open source software, and we would welcome contributions
...
* [lebowskiscoindev on reddit](https://www.reddit.com/r/lebowskiscoindev/)

## Branch Strategy

LebowskisCoin Core's default branch is intentionally a stable release, so that anyone
...
LebowskisCoin Core is a direct fork of Bitcoin Core and therefore benefits from as
