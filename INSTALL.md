# Installing LebowskisCoin Core

### Pre-compiled binaries

The easiest way to install the latest version of the LebowskisCoin Core software is
...
It is possible to build your own copy of LebowskisCoin Core with the exact, tested,
dependencies, as used for the binary releases, by using the
[depends system](depends/description.md). Please refer to the
[depends README](depends/README.md) for instructions to build LebowskisCoin using
these dependencies.

### Compiling using system-provided libraries

  The following are developer notes on how to build LebowskisCoin on your native
  ...
  - [macOS Build Notes](doc/Building-LebowskisCoin-1.14-for-Mac.md)
...
LebowskisCoin Core is a multithreaded application, and deadlocks or other multithreading bugs
