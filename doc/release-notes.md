LebowskisCoin Core version 1.14.6 is now available from:
...
Releases are also announced on reddit:
  ...
  <https://www.reddit.com/r/lebowskiscoindev/>
...
```
lebowskiscoin-cli addnode <address> remove
```
...
```
lebowskiscoin-cli liststucktransactions
```
...
```
lebowskiscoin-cli setmaxconnections <desired_amount>
```
...
```
lebowskiscoin-cli rescan <start_block>
```
